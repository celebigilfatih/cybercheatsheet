...
async function inspectDirsearch() {
    try {
        await dbConnect();
        const sheet = await Cheatsheet.findOne({ 'title.en': 'Dirsearch Cheat Sheet' }).lean();

        if (sheet) {
            console.log('Found Dirsearch Cheatsheet:');
            ...
            console.log('Dirsearch Cheatsheet NOT FOUND');
        }
