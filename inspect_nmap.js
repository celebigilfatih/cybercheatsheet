...
async function inspectNmap() {
    try {
        await dbConnect();
        const sheet = await Cheatsheet.findOne({ 'title.en': 'Nmap Cheat Sheet' }).lean();

        if (sheet) {
            console.log('Found Nmap Cheatsheet:');
            ...
            console.log('Nmap Cheatsheet NOT FOUND');
        }
